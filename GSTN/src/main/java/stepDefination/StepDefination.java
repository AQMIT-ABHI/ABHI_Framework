...
import pages.NSTPindividualFlow;
...
//	
		...
		//31-08-2020
		public void STPfamilyfill(WebDriver driver, String testScenarioID, XSSFWorkbook workbook, Connection conn,
		String stepGroup, CustomAssert customAssert) throws Exception {
		STPFamily_Flow stpfamily = new STPFamily_Flow(driver);
		stpfamily.STPfamilyDetails(driver, testScenarioID, workbook, conn, stepGroup, customAssert);
		}
		
		
		//31-08-2020
		public void NSTPfamilyfill(WebDriver driver, String testScenarioID, XSSFWorkbook workbook, Connection conn,
		String stepGroup, CustomAssert customAssert) throws Exception {
		NSTPFamily_Flow nstpfamily = new NSTPFamily_Flow(driver);
		nstpfamily.NSTPfamilyDetails(driver, testScenarioID, workbook, conn, stepGroup, customAssert);
		}
		
		//31-08-2020
		public void NSTPindividualfill(WebDriver driver, String testScenarioID, XSSFWorkbook workbook, Connection conn,
		String stepGroup, CustomAssert customAssert) throws Exception {
		NSTPindividualFlow nstpIndiv=new NSTPindividualFlow(driver);
		nstpIndiv.NSTPIndiviDetails(driver, testScenarioID, workbook, conn, stepGroup, customAssert);
		}
		
		
		//1-09-2020
		public void UWRNSTPindividualfill(WebDriver driver, String testScenarioID, XSSFWorkbook workbook, Connection conn,
			String stepGroup, CustomAssert customAssert) throws Exception {
