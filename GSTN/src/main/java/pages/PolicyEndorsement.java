...
public class PolicyEndorsement extends GenericMethods {
	...
	@FindBy(xpath = "//div[contains(text(),'EIA')]//following::select[1]")
	private WebElement OptionalEIA;
	...
	@FindBy(xpath = "//div[contains(text(),'EIA')]//following::img[3]")
	private WebElement uploadrequirementEIA;
	...
	@FindBy(xpath="//select[@id='Relationship with Proposer0']")
	...
	private WebElement PolicyHolderMiddlename;
	//lastNAme
	@FindBy(xpath="//input[@id='Policy-holder Last Name (2)']")
	private WebElement PolicyHolderlastname;
	...
	private WebElement genderforPF;


	@FindBy(xpath="//input[@id='STD Code']")
	private WebElement Stdcode;

	@FindBy(xpath="//input[@id='Alternate Number']")
	private WebElement Alternatename;

	@FindBy(xpath="//select[@id='Educational Qualification']")
	...
	@FindBy(xpath="//input[@id='Address of Nominee0']")
	private WebElement AddressOfnominee;

	@FindBy(xpath="//input[@id='Appointee Name0']")
	private WebElement Appointeename;

	@FindBy(xpath="//select[@id='Relationship of Appointee with the Nominee0']")
	private WebElement relationshipWithAppointeeWithNominee;

	//gst

	@FindBy(xpath="//p[contains(text(),'Business Partners')][1]")
	private WebElement BusinessPartner;

	@FindBy(xpath="//input[@id='Party Code']")
	private WebElement PartyCode;

	@FindBy(xpath="//button[@id='Back'][2]")
	private WebElement AlterClient;

	@FindBy(xpath="//div//input[@id='txtSRCode']")
	private WebElement PartySrCode;

	@FindBy(xpath="//button[normalize-space()='Proceed']")
	private WebElement ProceedButton;

	@FindBy(xpath="//input[@id='Series Number of GST']")
	private WebElement SeriesNoOfGST;


	@FindBy(xpath="//BUTTON[@id='Back'][3]")
	...
	private WebElement MemberDetailslastname;

	@FindBy(xpath="//input[@id='Last Name 1']")
	private WebElement MemberDetailsMiddlename;

	@FindBy(xpath="//button[@name='Submit']")
	private WebElement submitForFinal;
	...
	public void fillEndorsement(WebDriver driver,String testCaseName, XSSFWorkbook workbook,Connection conn,String stepGroup,CustomAssert customAssert) throws Exception
	{
		...
		if (dataRow.getProperty("EndorsmentType").equalsIgnoreCase("PolicyMamagemnt"))

		{
			...
			if(dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification in Nominee Details")&&dataRow.getProperty("Policy").equalsIgnoreCase("Individual")||
					dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification in Nominee Details")&&dataRow.getProperty("Policy").equalsIgnoreCase("MultiIndividual"))
					...
					dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification in Nominee Details")&&dataRow.getProperty("Policy").equalsIgnoreCase("MultiIndividual"))
			{
				...
				Thread.sleep(WaitTime.low);
				//Nominee Gender
				if(!dataRow.getProperty("NomineeGender").isEmpty())
				{
					Thread.sleep(WaitTime.low);
				...
				{
					Thread.sleep(WaitTime.low);
					clearAndSenKeys(Appointeename,dataRow.getProperty("AppointeeName"),"Address of Nominee");
				}
				...
				if(!dataRow.getProperty("RelationshipofAppointeewiththeNominee").isEmpty())
				{
					Thread.sleep(WaitTime.low);
					clearAndSenKeys(relationshipWithAppointeeWithNominee,dataRow.getProperty("RelationshipofAppointeewiththeNominee"),"Address of Nominee");
				}
				//Nominee Save
				wait.until(ExpectedConditions.elementToBeClickable(nomineesaveBTN));
			...
			if(dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification in Member Details")&&dataRow.getProperty("Policy").equalsIgnoreCase("Individual"))
			{
				...
				//First Name
				if(!dataRow.getProperty("MDFirstname").isEmpty())
				{
				...
				if(!dataRow.getProperty("HeightCMS").isEmpty())
				{
					Thread.sleep(WaitTime.medium);
					clearAndSenKeys(heightcms, dataRow.getProperty("HeightCMS"), "Height CMS");
					Thread.sleep(WaitTime.low);
				}

				if(!dataRow.getProperty("HeightInch").isEmpty())
				{
					Thread.sleep(WaitTime.medium);
			...
			if(dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification in Policy Holder Details")&&dataRow.getProperty("Policy").equalsIgnoreCase("Individual")||
					dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification in Policy Holder Details")&&dataRow.getProperty("Policy").equalsIgnoreCase("MultiIndividual"))			{
				...
				if(!dataRow.getProperty("MDMiddletname").isEmpty())
				{
					clearAndSenKeys(PolicyHolderMiddlename,getRandomString(),"Middle Name" );
					Thread.sleep(WaitTime.medium);
				}

				if(!dataRow.getProperty("MDLastname").isEmpty())
				{
					clearAndSenKeys(PolicyHolderlastname,getRandomString(),"Last Name" );
				...
				selectFromDropdownByVisibleText(genderforPF,dataRow.getProperty("Gender"),"Gender");
				...
				if(!dataRow.getProperty("StdCode").isEmpty())
				{
					Thread.sleep(WaitTime.medium); 
					clearAndSenKeys(Stdcode,dataRow.getProperty("StdCode"), "STD Code");
				}
				if(!dataRow.getProperty("AlterNateName").isEmpty())
				{
					Thread.sleep(WaitTime.medium); 
					clearAndSenKeys(Alternatename,dataRow.getProperty("AlterNateName"), "AlterNate Name");
					Thread.sleep(WaitTime.high);
					Thread.sleep(WaitTime.low);
					click(driver.findElement(By.xpath("//span[contains(text(),'"+dataRow.getProperty("AlterNateName")+"')]")),"Clicked on AlternateName");
				}

				if(!dataRow.getProperty("EducationalQualification").isEmpty())
				{
					Thread.sleep(WaitTime.medium);
					selectFromDropdownByVisibleText(Educationalqualification,dataRow.getProperty("EducationalQualification"), "Type Of Educational Qualification");
				}
			...
			if(dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification in Payment Frequency")&&dataRow.getProperty("Policy").equalsIgnoreCase("Individual")||dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification in Payment Frequency")&&dataRow.getProperty("Policy").equalsIgnoreCase("MultiIndividual"))
			{
				click(basicdetails,"Basic Details");
				Thread.sleep(WaitTime.medium);
				switchtoframe(driver, "containerFrame");
			...
			if(dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification in EIA Number")&&dataRow.getProperty("Policy").equalsIgnoreCase("Individual")
					||dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification in EIA Number")&&dataRow.getProperty("Policy").equalsIgnoreCase("MultiIndividual"))
			{
			...
			if(dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification In Member Details")
					&&dataRow.getProperty("Policy").equalsIgnoreCase("MultiIndividual"))

			{
				
				wait.until(ExpectedConditions.elementToBeClickable(membericon));
				click(membericon,"Member Icon");
				switchtoframe(driver,"containerFrame");
				Thread.sleep(WaitTime.low);

				String MiddleNameFieldFlag = dataRow.getProperty("MiddleNameForMDConfig");
				ArrayList<String> MiddleNameFieldList = new ArrayList<String>(Arrays.asList(MiddleNameFieldFlag.split("\\+")));

				String LastNameFieldFlag = dataRow.getProperty("LastNameForMDConfig");
				ArrayList<String> LastNameFieldList = new ArrayList<String>(Arrays.asList(LastNameFieldFlag.split("\\+")));

				String WhatsappNumberFieldFlag = dataRow.getProperty("WhatsappNumberForMDConfig");
				ArrayList<String> WhatsappNumberFieldList = new ArrayList<String>(Arrays.asList(WhatsappNumberFieldFlag.split("\\+")));



				List<WebElement> tabitems = driver.findElements(By.xpath("//label[@id='Member Code']"));
				for(int i=0;i<tabitems.size();i++)
				{
					int y=i+1;
					click(driver.findElement(By.xpath("(//label[@id='Member Code'])[" + y + "]")), "Link no = " + y);
					switchtoframe(driver,"memberiframe"+(y-1));


					if (MiddleNameFieldList.get(i).equalsIgnoreCase("Yes")) {
						clearAndSenKeys(MemberDetailsMiddlename, getRandomString(), "Middle Name");
						Thread.sleep(WaitTime.low);
					}		
					if (LastNameFieldList.get(i).equalsIgnoreCase("Yes")) {
						clearAndSenKeys(MemberDetailslastname, getRandomString(), "Last Name");
						Thread.sleep(WaitTime.low);
					}		
					if (WhatsappNumberFieldList.get(i).equalsIgnoreCase("Yes")) {

						Thread.sleep(WaitTime.medium);
						whatsappnumber.sendKeys(Keys.chord(Keys.CONTROL, "a", Keys.DELETE));
						Thread.sleep(WaitTime.low);
						clearAndSenKeys(whatsappnumber, randomNumberGenerator(), "Whatsapp Number");
						Thread.sleep(WaitTime.low);
					}
				...
				switchtodefaultframe(driver);
				switchtoframe(driver, "display");
				click(requirementbtn,"Requirement Icon");
				switchtoframe(driver,"containerFrame");

			}

			if(dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification in Loan Account Number")&&dataRow.getProperty("Policy").equalsIgnoreCase("Individual")||dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification in Loan Account Number")&&dataRow.getProperty("Policy").equalsIgnoreCase("MultiIndividual"))
			{
				click(membericon,"Member Icon");
				Thread.sleep(WaitTime.low);
				switchtoframe(driver,"containerFrame");
			...
			{ 
				...
				if(dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification in Nominee Details")||dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification In Member Details"))
				{
					wait.until(ExpectedConditions.elementToBeClickable(Optional3));
					selectFromDropdownByVisibleText(Optional3,dataRow.getProperty("Optional Status"),"Selection Optional");	
				}
				else {
					wait.until(ExpectedConditions.elementToBeClickable(OptionalEIA));
					selectFromDropdownByVisibleText(OptionalEIA,dataRow.getProperty("Optional Status"),"Selection Optional");
				}

				Thread.sleep(WaitTime.low);

				if(dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification in Loan Account Number")||dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification In Member Details"))
				{
					click(uploadrequirementA, "Upload Document of BanK");
					switchToWindow(driver);
				}
				else {
					click(uploadrequirementEIA, "Upload Document of BanK");
					Thread.sleep(WaitTime.medium);
					switchToWindow(driver);
				}
				...
				wait.until(ExpectedConditions.elementToBeClickable(saverequire));
				click(saverequire, "Save");

				click(errorOk, "Confirmation Ok Button");
			}
			// Continue Button
			click(continueButton, "Continue Button");

			wait.until(ExpectedConditions.elementToBeClickable(submitForFinal));
			click(submitForFinal, "Submit Button");
			...
			if(dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification In Member Details")
					||dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification in Payment Frequency")
					||dataRow.getProperty("Endorsement type").equalsIgnoreCase("Modification in Policy Holder Details"))
			...
			Reporter.log("----------");
			Reporter.log("Endorsement status for this case is "+endorsementsts);
		...
		if (dataRow.getProperty("EndorsmentType").equalsIgnoreCase("Gst"))

		{
			...
			switchtodefaultframe(driver);
			switchtoframe(driver, "display");
			click(BusinessPartner,"Business Partner tab");

			Thread.sleep(WaitTime.medium);
			clearAndSenKeys(PartyCode,dataRow.getProperty("Party No"),"Party No Input");
			Thread.sleep(WaitTime.medium);
			click(SearchButton, "search");
			//Check status of Policy against endorsement
			if(dataRow.getProperty("Status").equalsIgnoreCase("Active Policy"))
			...
			driver.findElement(By.xpath("//input[@id='Party Code']")).sendKeys(Keys.PAGE_DOWN);
			Thread.sleep(2000);
			click(driver.findElement(By.xpath("//a[contains(text(),'"+dataRow.getProperty("Party No")+"')]")),"policy no");
			Thread.sleep(2000);
			String parentWindow1 = driver.getWindowHandle();
			Thread.sleep(WaitTime.low);
			switchtodefaultframe(driver);
			...
			Thread.sleep(WaitTime.low);
			switchtoframe(driver,"containerFrame");
			driver.findElement(By.xpath("//button[@id='Back'][2]")).sendKeys(Keys.PAGE_DOWN);
			Thread.sleep(2000);

			click(AlterClient, "Alter search");
			Thread.sleep(WaitTime.medium);
			//switchToWindowUsingTitleContains("Upload Data Files");
			clearAndSenKeys(PartySrCode, dataRow.getProperty("SRCode"), "SR Code of Party  Endorsement");
			...
			click(Okbutton,"OK Button");
			Thread.sleep(WaitTime.low);
			clearAndSenKeys(SeriesNoOfGST, dataRow.getProperty("SeriesNumberofGST"), "Series Number of GST");
			Thread.sleep(WaitTime.medium);
			clearAndSenKeys(whatsappnumber, dataRow.getProperty("WhatsAppNumber"), "WhatsApp Number");
			Thread.sleep(WaitTime.low);
			selectFromDropdownByVisibleText(countryofResidencE, dataRow.getProperty("CountryofResidence"),"Country of Residence");
			wait.until(ExpectedConditions.elementToBeClickable(Save));
			click(Save,"Save Button");
			Thread.sleep(WaitTime.low);
			wait.until(ExpectedConditions.elementToBeClickable(Okbutton));
			click(Okbutton,"OK Button");
			click(complete," completeButton");
			click(Okbutton,"OK Button");
